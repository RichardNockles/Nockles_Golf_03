...
@export var hole_start_positions: Array[Node3D]  # Assign `BallStartPos_01`, `BallStartPos_02` from `Course.tscn`
@export var course: Node3D  # Assign `Course.tscn` in Inspector
...
func spawn_ball():
    ...
    # ✅ Connect hole_completed signal AFTER instantiating
